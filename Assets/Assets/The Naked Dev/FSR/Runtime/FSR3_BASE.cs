...
namespace TND.FSR 
{
    ...
    public abstract class FSR3_BASE : MonoBehaviour
    {
        ...
        //Frame Generation
        public bool enableFG = false;
        public bool isFGFrame = false;
        ...
        public bool OnIsSupported() {
            bool fsrCompatible = SystemInfo.supportsComputeShaders;
        ...
        protected virtual void Initialize() {
            bool fsrCompatible = OnIsSupported();
        ...
        public void OnFGFlip() {
            if(m_mainCamera.cullingMask != 0) {
                originalCullingMask = m_mainCamera.cullingMask;
        ...
        public void OnDisableFG() {
            m_mainCamera.cullingMask = originalCullingMask;
            isFGFrame = false;
        }
