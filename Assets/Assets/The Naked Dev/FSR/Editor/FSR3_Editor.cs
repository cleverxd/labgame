    ...
    public class FSR3_Editor : Editor
    {
        ...
        public override void OnInspectorGUI() {
            ...
            if(EditorGUI.EndChangeCheck()) {
                ...
                fsrScript.enableFG = false;//frameGeneration;
                if(!fsrScript.enableFG) {
                    if(hasFGEnabled) {
                        hasFGEnabled = false;
                        fsrScript.OnDisableFG();
                    }
                } else {
                    hasFGEnabled = true;
                }
        ...
        private static class Styles
        {
            ...
            public static GUIContent FGText = new GUIContent("Frame Generation", "Toggle Frame Generation On and Off");
        }
    }
}
